...
print("La serie sigye la historia de "+nombrePrincipal+" "+apellidoPrincipal+"exestudiantedel dojo Cobra Kai")
print("quien busca la redencion reabriendo el infame dojo y reavivando, en el proceso")
print(f"su rivalidad con un ahora exitoso{nombreHeroe}{apellidoHeroe}")